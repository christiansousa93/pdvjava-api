package br.com.christiansousa93.pdvapi.config;
...
public class SpringFoxConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.christiansousa93.pdvapi"))
                .paths(regex("/api/pdv.*"))
                .build()
    ...
    private ApiInfo metaInfo() {
        return new ApiInfo(
                ...
                "1.0",
                "Terms of Service",
                new Contact("Christian Sousa", "https://www.linkedin.com/in/christiansousasilva",
                        "witney-christian@hotmail.com"),
