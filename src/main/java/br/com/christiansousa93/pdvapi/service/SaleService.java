package br.com.christiansousa93.pdvapi.service;
...
import br.com.christiansousa93.pdvapi.domain.entity.Sale;
import br.com.christiansousa93.pdvapi.domain.repository.SaleRepository;
import br.com.christiansousa93.pdvapi.dto.SaleDTO;
...
public class SaleService {
    ...
    public SaleDTO save(SaleDTO saleDto) {
        Sale teste = modelMapper.map(saleDto, Sale.class);
        Sale sale = saletRepository.save(teste);
